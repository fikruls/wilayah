...
CREATE TABLE `w_kecamatan` (
  ...
  `kabko_id` int DEFAULT NULL,
  `nama_kecamatan` varchar(44) DEFAULT NULL
...
INSERT INTO `w_kecamatan` (`id_kecamatan`, `kabko_id`, `nama_kecamatan`) VALUES
...
(110111, 1101, 'Labuhanhaji Timur'),
(110112, 1101, 'Labuhanhaji Barat'),
...
(110821, 1108, 'Nibong'),
(110822, 1108, 'Simpang Keuramat'),
(110823, 1108, 'Lapang'),
(110824, 1108, 'Pirak Timu'),
...
(120708, 1207, 'Sinembah Tanjung Muda Hilir'),
(120709, 1207, 'Bangun Purba'),
(120719, 1207, 'Galang'),
(120720, 1207, 'Sinembah Tanjung Muda Hulu'),
...
(130501, 1305, 'Lubuak Aluang'),
(130502, 1305, 'Batang Anai'),
(130503, 1305, 'Nan Sabaris'),
(130504, 1305, '2 x 11 Anam Lingkuang'),
(130505, 1305, 'VII Koto'),
(130506, 1305, 'V Koto'),
(130507, 1305, 'Sungai Garinggiang'),
(130508, 1305, 'Sungai Limau'),
(130509, 1305, 'IV Koto Aua Malintang'),
(130510, 1305, 'Ulakan Tapakih'),
(130511, 1305, 'Sintuak Toboh Gadang'),
(130512, 1305, 'VII Koto Padang Sago'),
(130513, 1305, 'Batang Gasan'),
(130514, 1305, 'V Koto Timur'),
(130515, 1305, '2 x 11 Kayu Tanam'),
(130516, 1305, 'Koto Patamuan'),
(130517, 1305, 'Anam Lingkuang'),
...
(131201, 1312, 'Sungai Beremas'),
(131202, 1312, 'Lembah Melintang'),
(131203, 1312, 'Pasaman'),
(131204, 1312, 'Talamau'),
(131205, 1312, 'Kinali'),
(131206, 1312, 'Gunung Tuleh'),
(131207, 1312, 'Ranah Batahan'),
(131208, 1312, 'Koto Balingka'),
(131209, 1312, 'Sungai Aur'),
(131210, 1312, 'Luhak Nan Duo'),
(131211, 1312, 'Sasak Ranah Pasisie'),
...
(140205, 1402, 'Peranap'),
(140206, 1402, 'Seberida'),
(140207, 1402, 'Batang Cenaku'),
(140208, 1402, 'Batang Gansal'),
(140209, 1402, 'Lirik'),
...
(167101, 1671, 'Ilir Barat Dua'),
(167102, 1671, 'Seberang Ulu Satu'),
(167103, 1671, 'Seberang Ulu Dua'),
(167104, 1671, 'Ilir Barat Satu'),
(167105, 1671, 'Ilir Timur Satu'),
(167106, 1671, 'Ilir Timur Dua'),
(167107, 1671, 'Sukarami'),
(167108, 1671, 'Sako'),
(167109, 1671, 'Kemuning'),
(167110, 1671, 'Kalidoni'),
(167111, 1671, 'Bukitkecil'),
(167112, 1671, 'Gandus'),
(167113, 1671, 'Kertapati'),
(167114, 1671, 'Plaju'),
(167115, 1671, 'Alang-alang Lebar'),
(167116, 1671, 'Sematangborang'),
...
(320110, 3201, 'Parung'),
(320111, 3201, 'Gunungsindur'),
(320112, 3201, 'Kemang'),
(320113, 3201, 'Bojonggede'),
...
(320318, 3203, 'Pagelarang'),
(320319, 3203, 'Tanggeung'),
(320320, 3203, 'Cubinong'),
...
(760215, 7602, 'Bonehau'),
(760216, 7602, 'Kepulauan Bala Balakang'),
(760301, 7603, 'Mambi'),
(760302, 7603, 'Aralle'),
(760303, 7603, 'Mamasa'),
(760304, 7603, 'Pana'),
...
(810801, 8108, 'Moa'),
(810802, 8108, 'Damer'),
(810803, 8108, 'Kepulauan Luang Sermata'),
(810804, 8108, 'Babar Barat'),
(810805, 8108, 'Pulau-pulau Babar Timur'),
(810806, 8108, 'Wetar Selatan'),
(810807, 8108, 'Kisar Selatan'),
...
(920231, 9202, 'Aimasi'),
(920232, 9202, 'Mokwam'),
(920233, 9202, 'Masni Utara'),
(920234, 9202, 'Wasirawi'),
(920235, 9202, 'Moruj Mega'),
(920301, 9203, 'Fak-Fak'),
...
(960115, 9601, 'Klayili'),
(960116, 9601, 'Klaso'),
(960117, 9601, 'Moisegen'),
(960118, 9601, 'Sorong'),
(960119, 9601, 'Bagun'),
(960120, 9601, 'Wemak'),
(960121, 9601, 'Sunook'),
(960122, 9601, 'Buk'),
(960123, 9601, 'Saengkeduk'),
(960124, 9601, 'Malabotom'),
(960125, 9601, 'Konhir'),
(960126, 9601, 'Klasafet'),
(960127, 9601, 'Hobard'),
(960128, 9601, 'Salawati Tengah'),
(960129, 9601, 'Botain'),
(960130, 9601, 'Sayosa Timur'),
(960201, 9602, 'Teminabuan'),
(960202, 9602, 'Inanwatan'),
(960203, 9602, 'Sawiat'),
(960204, 9602, 'Kokoda'),
(960205, 9602, 'Moswaren'),
(960206, 9602, 'Seremuk'),
(960207, 9602, 'Wayer'),
(960208, 9602, 'Kais'),
(960209, 9602, 'Konda'),
(960210, 9602, 'Matemani'),
(960211, 9602, 'Kokoda Utara'),
(960212, 9602, 'Saifi'),
(960213, 9602, 'Fokour'),
(960214, 9602, 'Salkma'),
(960215, 9602, 'Kais Darat'),
(960301, 9603, 'Misool (Misool Utara)'),
(960302, 9603, 'Waigeo Utara'),
(960303, 9603, 'Waigeo Selatan'),
(960304, 9603, 'Salawati Utara'),
(960305, 9603, 'Ayau'),
(960306, 9603, 'Misool Timur'),
(960307, 9603, 'Waigeo Barat'),
(960308, 9603, 'Waigeo Timur'),
(960309, 9603, 'Teluk Mayalibit'),
(960310, 9603, 'Kofiau'),
(960311, 9603, 'Meos Mansar'),
(960312, 9603, 'Misool Selatan'),
(960313, 9603, 'Warwarbomi'),
(960314, 9603, 'Waigeo Barat Kepulauan'),
(960315, 9603, 'Misool Barat'),
(960316, 9603, 'Kepulauan Sembilan'),
(960317, 9603, 'Kota Waisai'),
(960318, 9603, 'Tiplol Mayalibit'),
(960319, 9603, 'Batanta Utara'),
(960320, 9603, 'Salawati Barat'),
(960321, 9603, 'Salawati Tengah'),
(960322, 9603, 'Supnin'),
(960323, 9603, 'Kepulauan Ayau'),
(960324, 9603, 'Batanta Selatan'),
(960401, 9604, 'Fef'),
(960402, 9604, 'Miyah'),
(960403, 9604, 'Yembun'),
(960404, 9604, 'Kwoor'),
(960405, 9604, 'Sausapor'),
(960406, 9604, 'Abun'),
(960407, 9604, 'Syujak'),
(960408, 9604, 'Moraid'),
(960409, 9604, 'Kebar'),
(960410, 9604, 'Amberbaken'),
(960411, 9604, 'Senopi'),
(960412, 9604, 'Mubrani'),
(960413, 9604, 'Bikar'),
(960414, 9604, 'Bamusbama'),
(960415, 9604, 'Ases'),
(960416, 9604, 'Miyah Selatan'),
(960417, 9604, 'Ireres'),
(960418, 9604, 'Tobouw');
INSERT INTO `w_kecamatan` (`id_kecamatan`, `kabko_id`, `nama_kecamatan`) VALUES
(960419, 9604, 'Wilhem Roumbouts'),
(960420, 9604, 'Tinggouw'),
(960421, 9604, 'Kwesefo'),
(960422, 9604, 'Mawabuan'),
(960423, 9604, 'Kebar Timur'),
(960424, 9604, 'Kebar Selatan'),
(960425, 9604, 'Manekar'),
(960426, 9604, 'Mpur'),
(960427, 9604, 'Amberbaken Barat'),
(960428, 9604, 'Kasi'),
(960429, 9604, 'Selemkai'),
(960501, 9605, 'Aifat'),
(960502, 9605, 'Aifat Utara'),
(960503, 9605, 'Aifat Timur'),
(960504, 9605, 'Aifat Selatan'),
(960505, 9605, 'Aitinyo Barat'),
(960506, 9605, 'Aitinyo'),
(960507, 9605, 'Aitinyo Utara'),
(960508, 9605, 'Ayamaru'),
(960509, 9605, 'Ayamaru Utara'),
(960510, 9605, 'Ayamaru Timur'),
(960511, 9605, 'Mare'),
(960512, 9605, 'Aifat Timur Tengah'),
(960513, 9605, 'Aifat Timur Jauh'),
(960514, 9605, 'Aifat Timur Selatan'),
(960515, 9605, 'Ayamaru Selatan'),
(960516, 9605, 'Ayamaru Jaya'),
(960517, 9605, 'Ayamaru Selatan Jaya'),
(960518, 9605, 'Ayamaru Timur Selatan'),
(960519, 9605, 'Ayamaru Utara Timur'),
(960520, 9605, 'Ayamaru Tengah'),
(960521, 9605, 'Ayamaru Barat'),
(960522, 9605, 'Aitinyo Tengah'),
(960523, 9605, 'Aitinyo Raya'),
(960524, 9605, 'Mare Selatan'),
(967101, 9671, 'Sorong'),
